...
function About() {
    return (<>
        <div className="about-section bg-white text-black flex flex-col justify-center items-center">
            ...
            <div className="skills-section p-5 text-sm max-w-full lg:max-w-[1000px] text-left min-h-[30vh]">
                ...
                <div className="grid justify-center align-center grid-cols-2 md:grid-cols-4 lg:grid-cols-auto gap-4 mt-8 max-w-[900px] lg:mx-auto w-full">                    
                    <div className="bg-gray-100 grow size-45 p-1 rounded shadow"><img className="object-contain" src="https://picsum.photos/500/500?random=1"/></div>
                    <div className="bg-gray-100 grow size-45 p-1 rounded shadow"><img className="object-contain" src="https://picsum.photos/500/500?random=2"/></div>
                    <div className="bg-gray-100 grow size-45 p-1 rounded shadow"><img className="object-contain" src="https://picsum.photos/500/500?random=3"/></div>
                    <div className="bg-gray-100 grow size-45 p-1 rounded shadow"><img className="object-contain" src="https://picsum.photos/500/500?random=4"/></div>
                </div>
            </div>
        </div>
        <Interested />
