...
const Hero = () => {
    ...
    const icons = ["fa-linkedin-in", "fa-github", "fa-twitter", "fa-facebook-f", "fa-whatsapp"];
        ...
        <section className="hero flex flex-col justify-center items-center text-center p-10 bg-gray-100 text-gray-800 min-h-[90vh]">
            ...
            <div className='social-icons flex text-lg space-x-4 text-gray-600 mb-5'>
                {icons.map((icon, index) => (
                    <a href="#" key={index}><i className={`fa-brands hover:text-orange-500 ${icon}`}></i></a>
                ))}
            </div>
            <Skills items={skills} />
            ...
            <div className='hero-buttons flex justify-center items-center mt-5'>
                ...
                <button className='cursor-pointer bg-white text-gray-800 border border-gray-800 px-4 py-2 rounded-lg mt-5 ml-4 hover:bg-gray-200 transition-colors duration-300'>Hire Me</button>
            </div>
        </section>
    );
};
